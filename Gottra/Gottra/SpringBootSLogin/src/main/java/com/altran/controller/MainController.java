...
import com.altran.repository.UsersecurityRepository;
import com.altran.service.UsersecurityService;
...
public class MainController {
	    ...
	    public String login() {
			if (isAuthenticated()) { // TODO is there a better way to do this ?
